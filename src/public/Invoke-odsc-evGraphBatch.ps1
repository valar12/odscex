function Invoke-odsc-evGraphBatch {
    [CmdletBinding()]
    param(
    ...
    Invoke-odsc-evApiRequest -Resource '$batch' -Method ([Microsoft.PowerShell.Commands.WebRequestMethod]::Post) -Body $Body -DoNotUsePrefer
}
