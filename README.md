...
* [Repository review and roadmap](#repository-review-and-roadmap)
* [Licensing](#licensing)
...
See [docs/REPO_REVIEW.md](docs/REPO_REVIEW.md) for a prioritized review of additional features and capabilities that would make `odscex` safer, more useful, and more accessible for tenant-scale shortcut management.
