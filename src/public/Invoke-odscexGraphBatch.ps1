function Invoke-odscexGraphBatch {
    [CmdletBinding()]
    param(
    ...
    Invoke-odscexApiRequest -Resource '$batch' -Method ([Microsoft.PowerShell.Commands.WebRequestMethod]::Post) -Body $Body -DoNotUsePrefer
}
