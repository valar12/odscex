...
Module Name: odsc-ev
online version: https://github.com/innovara/odsc-ev/blob/main/docs/Invoke-odsc-evShortcutAssignment.md
schema: 2.0.0
---
...
## DESCRIPTION
The **Invoke-odsc-evShortcutAssignment** command is part of the enterprise management surface for odsc-ev. Use these commands to resolve target users, apply desired shortcut state, run assignment plans, validate permissions, and produce operational reports.
