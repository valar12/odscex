function Get-odsc-ev {
    ...
    process {
        ...
        $ShortcutRequest = @{
            Resource = Join-odsc-evDrivePathResource -User $User -RelativePath $RelativePath -Name $ShortcutName
            Method = [Microsoft.PowerShell.Commands.WebRequestMethod]::Get
        }

        $ShortcutResponse = Invoke-odsc-evApiRequest @ShortcutRequest
