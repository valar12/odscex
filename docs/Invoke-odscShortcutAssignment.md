...
## DESCRIPTION
The **Invoke-odscShortcutAssignment** command is part of the enterprise management surface for odsc. Use these commands to resolve target users, apply desired shortcut state, run assignment plans, validate permissions, and produce operational reports.
