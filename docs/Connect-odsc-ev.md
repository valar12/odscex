...
Module Name: odsc-ev
online version: https://github.com/innovara/odsc-ev/blob/main/docs/Connect-odsc-ev.md
schema: 2.0.0
---
...
```
Connect-odsc-ev -TenantId <String> -ClientId <String> -ClientSecret <SecureString> [-Cloud <String>] [-AzureCloudInstance <Integer>] [-GraphEndpoint <String>] [<CommonParameters>]
```

### ClientCertificate
```
Connect-odsc-ev -TenantId <String> -ClientId <String> -ClientCertificate <X509Certificate2> [-Cloud <String>] [-AzureCloudInstance <Integer>] [-GraphEndpoint <String>] [<CommonParameters>]
```

## DESCRIPTION
The **Connect-odsc-ev** function authenticates and creates a session to the Microsoft Graph API. Use `-Cloud` to select the Microsoft Graph and token authority endpoints for worldwide, GCC, GCC High, DoD, and China environments.
...
```powershell
PS C:\> Connect-odsc-ev -TenantId "00000000-0000-0000-0000-000000000000" -ClientId "00000000-0000-0000-0000-000000000000" -ClientSecret (ConvertTo-SecureString -String "000000000000000000000000000" -AsPlainText -Force)
```
...
```powershell
PS C:\> Connect-odsc-ev -TenantId "00000000-0000-0000-0000-000000000000" -ClientId "00000000-0000-0000-0000-000000000000" -ClientCertificate (Get-Item -Path 'Cert:\CurrentUser\My\0000000000000000000000000000000000000000')
```
...
```powershell
PS C:\> Connect-odsc-ev -Cloud GCC -TenantId "00000000-0000-0000-0000-000000000000" -ClientId "00000000-0000-0000-0000-000000000000" -ClientSecret (ConvertTo-SecureString -String "000000000000000000000000000" -AsPlainText -Force)
```
...
```powershell
PS C:\> Connect-odsc-ev -Cloud GCCHigh -TenantId "00000000-0000-0000-0000-000000000000" -ClientId "00000000-0000-0000-0000-000000000000" -ClientCertificate (Get-Item -Path 'Cert:\CurrentUser\My\0000000000000000000000000000000000000000')
```
