...
Module Name: odscex
online version: https://github.com/innovara/odscex/blob/main/docs/Invoke-odscexApply.md
schema: 2.0.0
---
...
## DESCRIPTION
The **Invoke-odscexApply** command is part of the enterprise management surface for odscex. Use these commands to resolve target users, apply desired shortcut state, run assignment plans, validate permissions, and produce operational reports.
